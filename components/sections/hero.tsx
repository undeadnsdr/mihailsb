    ...
    <Section id="hero" className="pt-2 pb-2 md:pt-4 md:pb-3 lg:pt-6 lg:pb-4" labelledBy="hero-title">
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12 lg:items-stretch">
        ...
        <Reveal step={1} className="flex flex-col gap-4 lg:col-span-5 lg:h-full">
          ...
          {/* На смартфоне и планшете (до lg) плитку прячем: герой и без
              неё занимает весь первый экран, а обратный звонок доступен
              из верхней панели связи и финальной формы. От lg — десктопная
              колонка узкая и высокая, там плитка возвращается и
