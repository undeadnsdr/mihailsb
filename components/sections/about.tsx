...
export function About() {
  return (
    // Section даёт одинаковый py сверху и снизу, а About идёт сразу под
    // бегущей строкой преимуществ (у которой своего нижнего отступа нет) —
    // стандартный верхний зазор смотрелся вдвое больше нижнего до следующей
    // секции. pt-* после py-* переопределяет только верхний паддинг,
    // pb-* повторяет исходные значения Section, чтобы не менять ритм ниже.
    <Section
      id="about"
      labelledBy="about-title"
      className="pt-6 pb-12 md:pt-8 md:pb-14 lg:pt-10 lg:pb-[70px]"
    >
