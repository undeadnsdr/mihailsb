 ...
 *
 * Справа именно обратный звонок, а не «написать»: кнопка Telegram уже
 * стоит в навигации строкой ниже, и второе такое же действие в одном
 * кадре не добавляло бы ничего. Обратный звонок — отдельный сценарий для
 * тех, кто не хочет ни звонить сам, ни писать.
 *
