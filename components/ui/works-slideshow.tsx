...
type Slide = {
  ...
  short: string
  /**
   * Высота полотна внутри кадра. h-[240%] — страница длиннее экрана, её
   * прокручивают. h-full — страница ровно в экран, прокручивать нечего
   */
  height: string
 ...
 */
const slides: Slide[] = [
  { kind: 'laptop', label: 'Ноутбук', short: 'Ноутбук', height: 'h-[240%]', pass: '7s', passMs: 7000 },
  {
